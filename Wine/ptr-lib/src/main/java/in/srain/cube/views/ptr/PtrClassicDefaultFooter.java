...
public class PtrClassicDefaultFooter extends FrameLayout implements PtrUIHandler {
    ...
    public void setLastUpdateTextSize(float lastUpdateTextSize) {
        mLastUpdateTextView.setTextSize(lastUpdateTextSize);
    }

    public void setLastUpdateTextColor(int lastUpdateTextColor) {
        mLastUpdateTextView.setTextColor(lastUpdateTextColor);
    }
