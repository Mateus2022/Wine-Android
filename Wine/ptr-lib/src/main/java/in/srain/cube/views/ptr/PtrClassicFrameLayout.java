...
public class PtrClassicFrameLayout extends PtrFrameLayout {
    ...
    private void initViews() {
        ...
        setOnMotionEvent(new OnMotionEvent() {
            @Override
            public void motionEvent(MotionEvent e) {
                if (mOnMyMotionEvent != null)
                    mOnMyMotionEvent.motionEvent(e);
            }
        });
    }

    private OnMyMotionEvent mOnMyMotionEvent;

    public void setOnMotionEvent(OnMyMotionEvent onMotionEvent) {
        mOnMyMotionEvent = onMotionEvent;
    }

    public interface OnMyMotionEvent {
